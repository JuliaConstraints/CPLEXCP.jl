...
const IloIntervalSequenceVar =
    JavaObject{Symbol("ilog.concert.IloIntervalSequenceVar")}
...
const IloNumToNumSegmentFunction =
    JavaObject{Symbol("ilog.concert.IloNumToNumSegmentFunction")}
const IloNumToNumStepFunction =
    JavaObject{Symbol("ilog.concert.IloNumToNumStepFunction")}
const IloCumulFunctionExpr =
    JavaObject{Symbol("ilog.concert.IloCumulFunctionExpr")}
const IloTransitionDistance =
    JavaObject{Symbol("ilog.concert.IloTransitionDistance")}
...
const IloMultiCriterionExpr =
    JavaObject{Symbol("ilog.concert.IloMultiCriterionExpr")}
...
const Addable =
    Union{Constraint, IloObjective, IloMultiCriterionExpr, Variable, NumExpr}

const ConstraintArray =
    Union{Vector{Constraint}, Vector{T} where {T <: Constraint}}
...
struct JavaCPOModel
    ...
    conflictstatus_possible::Any
    conflictstatus_member::Any
...
function cpo_java_model()
    ...
    conflictstatus_member =
        jfield(conflictstatus, "ConflictMember", conflictstatus)
    conflictstatus_excluded =
        jfield(conflictstatus, "ConflictExcluded", conflictstatus)
...
function cpo_java_intervalvar(
    ...
    return jcall(
        ...
        "intervalVar",
        IloIntervalVar,
        (jint, jint, jboolean, IloNumToNumStepFunction, jint),
        size_lb,
        size_ub,
        opt,
        intensity,
...
function cpo_java_intervalsequencevar(
    cp::JavaCPOModel,
    intervalvararray::Vector{IloIntervalVar},
    name::String="",
)
    if length(name) == 0
        return jcall(
...
function cpo_java_intervalsequencevar(
    ...
    if length(name) == 0
        return jcall(
            ...
            "intervalSequenceVar",
            IloIntervalSequenceVar,
            (Vector{IloIntervalVar}, Vector{jint}),
            intervalvararray,
            types,
        )
    else
        return jcall(
            ...
            "intervalSequenceVar",
            IloIntervalSequenceVar,
            (Vector{IloIntervalVar}, Vector{jint}, JString),
            intervalvararray,
            types,
            name,
        )
...
function cpo_java_element(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    f::IloNumToNumSegmentFunction,
)
    return jcall(
        cp.cp,
        "endEval",
        IloNumExpr,
        (IloIntervalVar, IloNumToNumSegmentFunction),
        a,
        f,
    )
end
...
function cpo_java_element(
    ...
    return jcall(
        ...
        "endEval",
        IloNumExpr,
        (IloIntervalVar, IloNumToNumSegmentFunction, jdouble),
        a,
        f,
        absval,
    )
...
function cpo_java_enfofnext(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    lastval::Int32,
)
    return jcall(
        cp.cp,
        "endOfNext",
        IloIntExpr,
        (IloIntervalSequenceVar, IloIntervalVar, jint),
        var_seq,
        var_interval,
        lastval,
    )
...
function cpo_java_enfofnext(
    ...
    return jcall(
        ...
        "endOfNext",
        IloIntExpr,
        (IloIntervalSequenceVar, IloIntervalVar, jint, jint),
        var_seq,
        var_interval,
        lastval,
        absval,
...
function cpo_java_enfofprevious(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    firstval::Int32,
...
function cpo_java_heightatend(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    f::IloCumulFunctionExpr,
)
    return jcall(
        cp.cp,
        "heightAtEnd",
        IloIntExpr,
        (IloIntervalVar, IloCumulFunctionExpr),
        a,
        f,
    )
end
...
function cpo_java_heightatend(
    ...
    return jcall(
        ...
        "heightAtEnd",
        IloIntExpr,
        (IloIntervalVar, IloCumulFunctionExpr, jint),
        a,
        f,
        absval,
    )
...
function cpo_java_heightatstart(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    f::IloCumulFunctionExpr,
)
...
function cpo_java_lengthofnext(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    lastval::Int32,
...
function cpo_java_lengthofprevious(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    firstval::Int32,
...
function cpo_java_overlaplength(
    cp::JavaCPOModel,
    var_a::IloIntervalVar,
    var_b::IloIntervalVar,
)
    return jcall(
        cp.cp,
        "overlapLength",
        IloIntExpr,
        (IloIntervalVar, IloIntervalVar),
        var_a,
        var_b,
    )
end
...
function cpo_java_overlaplength(
    ...
    return jcall(
        ...
        "overlapLength",
        IloIntExpr,
        (IloIntervalVar, IloIntervalVar, jint),
        var_a,
        var_b,
        absval,
    )
...
function cpo_java_piecewiselinear(
    cp::JavaCPOModel,
    var::IloIntervalVar,
    point::Vector{T},
    slope::Vector{T},
    ...
    return jcall(
        ...
        "piecewiseLinear",
        IloNumExpr,
        (IloNumExpr, Vector{jdouble}, Vector{jdouble}, jdouble, jdouble),
        var,
        point,
        slope,
        a,
...
function cpo_java_piecewiselinear(
    ...
    return jcall(
        ...
        "piecewiseLinear",
        IloNumExpr,
        (IloNumExpr, jdouble, Vector{jdouble}, Vector{jdouble}, jdouble),
        var,
        firstslope,
        point,
        value,
...
function cpo_java_prod(
    cp::JavaCPOModel,
    exprs_a::IntExprArray,
    exprs_b::IntExprArray,
)
    return jcall(
        cp.cp,
        "prod",
        IloIntExpr,
        (Vector{IloIntExpr}, Vector{IloIntExpr}),
        exprs_a,
        exprs_b,
    )
end
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearNumExpr,
        (Vector{jdouble}, Vector{IloNumVar}),
        coefs,
        vars,
    )
end
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearNumExpr,
        (Vector{jdouble}, Vector{IloNumVar}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_scalprod(
    cp::JavaCPOModel,
    coefs::Vector{IloIntVar},
    vars::Vector{IloIntVar},
)
    return jcall(
        cp.cp,
        "scalProd",
        IloIntExpr,
        (Vector{IloIntVar}, Vector{IloIntVar}),
        coefs,
        vars,
    )
end
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloIntExpr,
        (Vector{IloIntVar}, Vector{IloIntVar}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearIntExpr,
        (Vector{IloIntVar}, Vector{jint}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearNumExpr,
        (Vector{IloNumVar}, Vector{jdouble}),
        coefs,
        vars,
    )
end
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearNumExpr,
        (Vector{IloNumVar}, Vector{jdouble}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloNumExpr,
        (Vector{IloNumVar}, Vector{IloNumVar}),
        coefs,
        vars,
    )
end
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloNumExpr,
        (Vector{IloNumVar}, Vector{IloNumVar}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_scalprod(
    ...
    return jcall(
        ...
        "scalProd",
        IloLinearIntExpr,
        (Vector{jint}, Vector{IloIntVar}, jint, jint),
        coefs,
        vars,
        start,
        num,
...
function cpo_java_sizeof(cp::JavaCPOModel, a::IloIntervalVar, absval::Real)
    return jcall(
        ...
        "sizeOf",
        IloNumExpr,
        (IloIntervalVar, jdouble),
        a,
        absval,
    )
end

function cpo_java_sizeofnext(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    lastval::Int32,
...
function cpo_java_sizeofnext(
    ...
    return jcall(
        ...
        "sizeOfNext",
        IloIntExpr,
        (IloIntervalSequenceVar, IloIntervalVar, jint, jdouble),
        var_seq,
        var_interval,
        lastval,
        absval,
...
function cpo_java_sizeofprevious(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    firstval::Int32,
...
function cpo_java_standarddeviation(
    cp::JavaCPOModel,
    exprs::IntExprArray,
    mean_lb::Real,
    mean_ub::Real,
    ...
    return jcall(
        ...
        "standardDeviation",
        IloNumExpr,
        (Vector{IloIntExpr}, jdouble, jdouble),
        exprs,
        mean_lb,
        mean_ub,
    )
...
function cpo_java_startofprevious(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    firstval::Int32,
...
function cpo_java_typeofprevious(
    cp::JavaCPOModel,
    var_seq::IloIntervalSequenceVar,
    var_interval::IloIntervalVar,
    firstval::Int32,
...
function cpo_java_linearintexpr_add(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
    sc::IloLinearIntExpr,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_linearintexpr_addterm(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
    var::IloIntVar,
    coef::Int32,
...
function cpo_java_linearintexpr_addterms(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
    var::Vector{IloIntVar},
    coef::Vector{Int32},
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
    return jcall(
...
function cpo_java_linearintexpr_getconstant(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_linearintexpr_remove(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
    var::IloIntVar,
)
...
function cpo_java_linearintexpr_setconstant(
    cp::JavaCPOModel,
    lis::IloLinearIntExpr,
    val::Int32,
)
...
function cpo_java_linearnumexpr_add(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
    sc::IloLinearNumExpr,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_linearnumexpr_addterm(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
    var::IloNumVar,
    coef::Int32,
...
function cpo_java_linearnumexpr_addterms(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
    var::Vector{IloNumVar},
    coef::Vector{T},
) where {T <: Real}
    # cp argument is useless, but kept to be consistent with the rest of the API.
    return jcall(
...
function cpo_java_linearnumexpr_getconstant(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_linearnumexpr_remove(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
    var::IloNumVar,
)
...
function cpo_java_linearnumexpr_setconstant(
    cp::JavaCPOModel,
    lis::IloLinearNumExpr,
    val::Real,
)
...
function cpo_java_inttupleset_addtuple(
    cp::JavaCPOModel,
    its::IloIntTupleSet,
    tuple::Vector{Int32},
)
...
function cpo_java_numtonumsegmentfunction(
    cp::JavaCPOModel,
    x::Vector{Real},
    v::Vector{Real},
)
    return jcall(
        ...
        "numToNumSegmentFunction",
        IloNumToNumSegmentFunction,
        (Vector{jdouble}, Vector{jdouble}),
        x,
        v,
    )
end

function cpo_java_piecewiselinearfunction(
    cp::JavaCPOModel,
    point::Vector{T},
    slope::Vector{T},
    a::Real,
    ...
    if length(name) == 0
        return jcall(
            ...
            IloNumToNumSegmentFunction,
            (Vector{jdouble}, Vector{jdouble}, jdouble, jdouble),
            point,
            slope,
            a,
            fa,
        ...
        return jcall(
            ...
            "piecewiseLinearFunction",
            IloNumToNumSegmentFunction,
            (Vector{jdouble}, Vector{jdouble}, jdouble, jdouble, JString),
            point,
            slope,
            a,
            fa,
...
function cpo_java_numtonumsegmentfunction_add(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    f::IloNumToNumSegmentFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumsegmentfunction_addvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_copy(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumsegmentfunction_dilate(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    k::Real,
)
...
function cpo_java_numtonumsegmentfunction_getarea(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_getdefinitionintervalmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumsegmentfunction_getdefinitionintervalmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumsegmentfunction_getmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_getmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_getvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x::Real,
)
...
function cpo_java_numtonumsegmentfunction_prod(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    k::Real,
)
...
function cpo_java_numtonumsegmentfunction_setmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_setmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_setperiodic(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    f::IloNumToNumSegmentFunction,
    x0::Real,
    ...
    return jcall(
        ...
        "setPeriodic",
        Nothing,
        (IloNumToNumSegmentFunction, jdouble, jdouble, jdouble),
        f,
        x0,
        n,
        dval,
...
function cpo_java_numtonumsegmentfunction_setperiodicvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
    ...
    return jcall(
        ...
        "setPeriodicValue",
        Nothing,
        (jdouble, jdouble, IloNumToNumSegmentFunction, jdouble),
        x1,
        x2,
        f,
        offset,
...
function cpo_java_numtonumsegmentfunction_setslope(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_setvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumsegmentfunction_shift(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    dx::Real,
    dval::Real,
...
function cpo_java_numtonumsegmentfunction_sub(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumSegmentFunction,
    f::IloNumToNumSegmentFunction,
)
...
function cpo_java_numtonumstepfunction_add(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    f::IloNumToNumStepFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
    return jcall(n2nsf, "add", Nothing, (IloNumToNumStepFunction,), f)
end

function cpo_java_numtonumstepfunction_addvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_copy(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumstepfunction_dilate(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    k::Real,
)
...
function cpo_java_numtonumstepfunction_getarea(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_getdefinitionintervalmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumstepfunction_getdefinitionintervalmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
...
function cpo_java_numtonumstepfunction_getmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_getmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_getvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x::Real,
)
...
function cpo_java_numtonumstepfunction_prod(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    k::Real,
)
...
function cpo_java_numtonumstepfunction_setmax(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_setmin(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_setperiodic(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    f::IloNumToNumStepFunction,
    x0::Real,
    ...
    return jcall(
        ...
        "setPeriodic",
        Nothing,
        (IloNumToNumStepFunction, jdouble),
        f,
        x0,
    )
end
...
function cpo_java_numtonumstepfunction_setperiodic(
    ...
    return jcall(
        ...
        "setPeriodic",
        Nothing,
        (IloNumToNumStepFunction, jdouble, jdouble),
        f,
        x0,
        n,
    )
...
function cpo_java_numtonumstepfunction_setperiodicvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
    ...
    return jcall(
        ...
        "setPeriodicValue",
        Nothing,
        (jdouble, jdouble, IloNumToNumStepFunction),
        x1,
        x2,
        f,
    )
...
function cpo_java_numtonumstepfunction_setperiodicvalue(
    ...
    return jcall(
        ...
        "setPeriodicValue",
        Nothing,
        (jdouble, jdouble, IloNumToNumStepFunction, jdouble),
        x1,
        x2,
        f,
        offset,
...
function cpo_java_numtonumstepfunction_setvalue(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    x1::Real,
    x2::Real,
...
function cpo_java_numtonumstepfunction_shift(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    dx::Real,
)
...
function cpo_java_numtonumstepfunction_sub(
    cp::JavaCPOModel,
    n2nsf::IloNumToNumStepFunction,
    f::IloNumToNumStepFunction,
)
...
function cpo_java_statefunction(
    cp::JavaCPOModel,
    t::IloTransitionDistance,
    name::String="",
)
    if length(name) == 0
        return jcall(
...
function cpo_java_diff(
    cp::JavaCPOModel,
    f1::IloCumulFunctionExpr,
    f2::IloCumulFunctionExpr,
)
    return jcall(
        cp.cp,
        "diff",
        IloCumulFunctionExpr,
        (IloCumulFunctionExpr, IloCumulFunctionExpr),
        f1,
        f2,
    )
end
...
function cpo_java_getsegmentstart(
    cp::JavaCPOModel,
    f::IloCumulFunctionExpr,
    i::Int32,
)
    return jcall(
        ...
        "getSegmentStart",
        jint,
        (IloCumulFunctionExpr, jint),
        f,
        i,
    )
end

function cpo_java_getsegmentend(
    cp::JavaCPOModel,
    f::IloCumulFunctionExpr,
    i::Int32,
)
...
function cpo_java_getsegmentvalue(
    cp::JavaCPOModel,
    f::IloCumulFunctionExpr,
    i::Int32,
)
...
function cpo_java_sum(cp::JavaCPOModel, f1::IloIntervalVar, f2::IloIntervalVar)
    return jcall(
        ...
        "sum",
        IloCumulFunctionExpr,
        (IloCumulFunctionExpr, cumulfunctionexpr),
        f1,
        f2,
    )
end
...
function cpo_java_transitiondistance(
    cp::JavaCPOModel,
    i::Int32,
    name::String="",
)
...
function cpo_java_transitiondistance_getsize(
    cp::JavaCPOModel,
    td::IloTransitionDistance,
)
    # cp argument is useless, but kept to be consistent with the rest of the API.
    return jcall(td, "getSize", jint, ())
end

function cpo_java_transitiondistance_getvalue(
    cp::JavaCPOModel,
    td::IloTransitionDistance,
    fromstate::Int32,
    tostate::Int32,
...
function cpo_java_transitiondistance_setvalue(
    cp::JavaCPOModel,
    td::IloTransitionDistance,
    fromstate::Int32,
    tostate::Int32,
...
function cpo_java_allmindistance(
    cp::JavaCPOModel,
    vars::Vector{IloIntExpr},
    k::Int32,
)
    return jcall(
        cp.cp,
...
function cpo_java_allowedassignments(
    cp::JavaCPOModel,
    expr::IntExpr,
    values::Vector{Int32},
)
...
function cpo_java_allowedassignments(
    cp::JavaCPOModel,
    vars::Vector{IloIntVar},
    values::IloIntTupleSet,
)
    return jcall(
        cp.cp,
        "allowedAssignments",
        IloConstraint,
        (Vector{IloIntVar}, IloIntTupleSet),
        vars,
        values,
    )
end

function cpo_java_alternative(
    cp::JavaCPOModel,
    interval_a::IloIntervalVar,
    intervals_b::Vector{IloIntervalVar},
    name::String="",
)
    if length(name) == 0
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}),
            interval_a,
            intervals_b,
        )
    else
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}, JString),
            interval_a,
            intervals_b,
            name,
        )
...
function cpo_java_alternative(
    ...
    if length(name) == 0
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}, jint),
            interval_a,
            intervals_b,
            value,
        )
        ...
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}, jint, JString),
            interval_a,
            intervals_b,
            value,
            name,
...
function cpo_java_alternative(
    ...
    if length(name) == 0
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}, IloIntExpr),
            interval_a,
            intervals_b,
            expr,
        )
        ...
        return jcall(
            ...
            "alternative",
            IloAlternative,
            (IloIntervalVar, Vector{IloIntervalVar}, IloIntExpr, JString),
            interval_a,
            intervals_b,
            expr,
            name,
...
function cpo_java_alwaysconstant(
    cp::JavaCPOModel,
    f::IloStateFunction,
    a::IloIntervalVar,
)
    return jcall(
        ...
        "alwaysConstant",
        IloConstraint,
        (IloStateFunction, IloIntervalVar),
        f,
        a,
    )
end
...
function cpo_java_alwaysconstant(
    ...
    return jcall(
        ...
        "alwaysConstant",
        IloConstraint,
        (IloStateFunction, IloIntervalVar, jboolean, jboolean),
        f,
        a,
        startalign,
        endalign,
...
function cpo_java_alwaysconstant(
    ...
    return jcall(
        ...
        "alwaysConstant",
        IloConstraint,
        (IloStateFunction, jint, jint, jboolean, jboolean),
        f,
        start,
        end_,
        startalign,
...
function cpo_java_alwaysequal(
    ...
    return jcall(
        ...
        "alwaysEqual",
        IloConstraint,
        (IloStateFunction, IloIntervalVar, jint, jboolean, jboolean),
        f,
        a,
        v,
        startalign,
...
function cpo_java_alwaysequal(
    ...
    return jcall(
        ...
        "alwaysEqual",
        IloConstraint,
        (IloStateFunction, jint, jint, jint),
        f,
        start,
        end_,
        v,
...
function cpo_java_alwaysequal(
    ...
    return jcall(
        ...
        "alwaysEqual",
        IloConstraint,
        (IloStateFunction, jint, jint, jint, jboolean, jboolean),
        f,
        start,
        end_,
        v,
...
function cpo_java_alwaysin(
    ...
    return jcall(
        ...
        "alwaysIn",
        IloConstraint,
        (IloCumulFunctionExpr, IloIntervalVar, jint, jint),
        f,
        a,
        vmin,
        vmax,
...
function cpo_java_alwaysin(
    ...
    return jcall(
        ...
        "alwaysIn",
        IloConstraint,
        (IloCumulFunctionExpr, jint, jint, jint, jint),
        f,
        start,
        end_,
        vmin,
...
function cpo_java_alwaysin(
    ...
    return jcall(
        ...
        "alwaysIn",
        IloConstraint,
        (IloStateFunction, IloIntervalVar, jint, jint),
        f,
        a,
        vmin,
        vmax,
...
function cpo_java_alwaysin(
    ...
    return jcall(
        ...
        "alwaysIn",
        IloConstraint,
        (IloStateFunction, jint, jint, jint, jint),
        f,
        start,
        end_,
        vmin,
...
function cpo_java_alwaysnostate(
    cp::JavaCPOModel,
    f::IloStateFunction,
    a::IloIntervalVar,
)
    return jcall(
        ...
        "alwaysNoState",
        IloConstraint,
        (IloStateFunction, IloIntervalVar, jint),
        f,
        a,
    )
end
...
function cpo_java_and(
    cp::JavaCPOModel,
    constrs::ConstraintArray,
    name::String="",
)
    if length(name) == 0
...
function cpo_java_and(
    ...
    if length(name) == 0
        return jcall(
            ...
            "and",
            IloAnd,
            (Vector{IloConstraint}, jint, jint),
            constrs,
            start,
            num,
        )
        ...
        return jcall(
            ...
            "and",
            IloAnd,
            (Vector{IloConstraint}, jint, jint, JString),
            constrs,
            start,
            num,
            name,
...
function cpo_java_and(
    ...
    if length(name) == 0
        return jcall(
            ...
            "and",
            IloAnd,
            (IloConstraint, IloConstraint, jint, jint),
            constr_a,
            constr_b,
        )
    else
        return jcall(
            ...
            "and",
            IloAnd,
            (IloConstraint, IloConstraint, jint, jint, JString),
            constr_a,
            constr_b,
            name,
        )
...
function cpo_java_before(
    cp::JavaCPOModel,
    seq::IloIntervalSequenceVar,
    pred::IloIntervalVar,
    succ::IloIntervalVar,
)
    return jcall(
        ...
        "before",
        IloConstraint,
        (IloIntervalSequenceVar, IloIntervalVar, IloIntervalVar),
        seq,
        pred,
        succ,
    )
...
function cpo_java_distribute(
    cp::JavaCPOModel,
    exprs_cards::IntExprArray,
    exprs_vars::IntExprArray,
)
    return jcall(
        cp.cp,
        "distribute",
...
function cpo_java_distribute(
    ...
    return jcall(
        ...
        "distribute",
        IloConstraint,
        (Vector{IloIntExpr}, Vector{jint}, Vector{IloIntExpr}),
        exprs_cards,
        values,
        exprs_vars,
    )
...
function cpo_java_element(
    ...
    return jcall(
        ...
        "element",
        IloConstraint,
        (IloIntExpr, IloIntExpr, Vector{jint}),
        expr_var,
        expr_index,
        values,
    )
...
function cpo_java_element(
    ...
    return jcall(
        ...
        "element",
        IloConstraint,
        (IloNumExpr, IloIntExpr, Vector{jdouble}),
        expr_var,
        expr_index,
        values,
    )
...
function cpo_java_endatend(
    cp::JavaCPOModel,
    expr_a::IloIntervalVar,
    expr_b::IloIntervalVar,
)
    return jcall(
        cp.cp,
        "endAtEnd",
...
function cpo_java_endatend(
    ...
    return jcall(
        ...
        "endAtEnd",
        IloConstraint,
        (IloIntervalVar, IloIntervalVar, IloIntExpr),
        expr_a,
        expr_b,
        expr_z,
    )
...
function cpo_java_endbeforeend(
    cp::JavaCPOModel,
    expr_a::IloIntervalVar,
    expr_b::IloIntervalVar,
)
...
function cpo_java_endbeforestart(
    cp::JavaCPOModel,
    expr_a::IloIntervalVar,
    expr_b::IloIntervalVar,
)
...
function cpo_java_first(
    ...
    return jcall(
        ...
        "first",
        IloConstraint,
        (IloIntervalSequenceVar, IloIntervalVar),
        var_seq,
        var_interval,
    )
end

function cpo_java_forbiddenassignments(
    cp::JavaCPOModel,
    expr::IntExpr,
    values::Vector{Int32},
)
...
function cpo_java_forbiddenassignments(
    cp::JavaCPOModel,
    exprs::Vector{IntExpr},
    values::Vector{IloIntTupleSet},
)
    return jcall(
        cp.cp,
        "forbiddenAssignments",
        IloConstraint,
        (Vector{IloIntExpr}, Vector{IloIntTupleSet}),
        exprs,
        values,
    )
end

function cpo_java_forbidend(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    f::IloNumToNumStepFunction,
)
    return jcall(
        ...
        "forbidEnd",
        IloConstraint,
        (IloIntervalVar, IloNumToNumStepFunction),
        a,
        f,
    )
end

function cpo_java_forbidextent(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    f::IloNumToNumStepFunction,
)
...
function cpo_java_ge(cp::JavaCPOModel, f::IloCumulFunctionExpr, vmin::IntExpr)
    return jcall(
        ...
        "ge",
        IloConstraint,
        (IloCumulFunctionExpr, IloIntExpr),
        f,
        vmin,
    )
end
...
function cpo_java_ge(cp::JavaCPOModel, vmin::IntExpr, f::IloCumulFunctionExpr)
    return jcall(
        ...
        "ge",
        IloConstraint,
        (IloIntExpr, IloCumulFunctionExpr),
        vmin,
        f,
    )
end
...
function cpo_java_ge(cp::JavaCPOModel, vmin::Int32, f::IloCumulFunctionExpr)
    return jcall(
        ...
        "ge",
        IloConstraint,
        (jint, IloCumulFunctionExpr),
        vmin,
        f,
    )
end

function cpo_java_ge(
    cp::JavaCPOModel,
    expr_a::Real,
    expr_b::NumExpr,
    name::String="",
...
function cpo_java_ifthen(
    ...
    if length(name) == 0
        ...
        return jcall(
            ...
            "ifThen",
            IloConstraint,
            (IloConstraint, IloConstraint, JString),
            constr_a,
            constr_b,
            name,
        )
...
function cpo_java_ifthenelse(
    ...
    return jcall(
        ...
        "ifThenElse",
        IloConstraint,
        (IloConstraint, IloConstraint, IloConstraint),
        constr_a,
        constr_b,
        constr_c,
    )
...
function cpo_java_isomorphism(
    cp::JavaCPOModel,
    vars_a::Vector{IloIntervalVar},
    vars_b::Vector{IloIntervalVar},
    name::String="",
)
    if length(name) == 0
        return jcall(
            ...
            "isomorphism",
            IloIsomorphism,
            (Vector{IloIntervalVar}, Vector{IloIntervalVar}),
            vars_a,
            vars_b,
        )
    else
        return jcall(
            ...
            "isomorphism",
            IloIsomorphism,
            (Vector{IloIntervalVar}, Vector{IloIntervalVar}, JString),
            vars_a,
            vars_b,
            name,
        )
...
function cpo_java_lexicographic(
    cp::JavaCPOModel,
    exprs_a::IntExprArray,
    exprs_b::IntExprArray,
)
...
function cpo_java_strictlexicographic(
    cp::JavaCPOModel,
    exprs_a::IntExprArray,
    exprs_b::IntExprArray,
)
...
function cpo_java_nooverlap(
    cp::JavaCPOModel,
    seq::IloIntervalSequenceVar,
    tdist::IloTransitionDistance,
    name::String="",
)
    if length(name) == 0
        return jcall(
            ...
            "noOverlap",
            IloNoOverlap,
            (IloIntervalSequenceVar, IloTransitionDistance),
            seq,
            tdist,
        )
    else
        return jcall(
            ...
            "noOverlap",
            IloNoOverlap,
            (IloIntervalSequenceVar, IloTransitionDistance, JString),
            seq,
            tdist,
            name,
        )
...
function cpo_java_nooverlap(
    ...
    if length(name) == 0
        return jcall(
            ...
            "noOverlap",
            IloNoOverlap,
            (IloIntervalSequenceVar, IloTransitionDistance, jboolean),
            seq,
            tdist,
            direct,
        )
        ...
        return jcall(
            ...
            "noOverlap",
            IloNoOverlap,
            (IloIntervalSequenceVar, IloTransitionDistance, jboolean, JString),
            seq,
            tdist,
            direct,
            name,
...
function cpo_java_pack(
    cp::JavaCPOModel,
    expr_load::IntExprArray,
    expr_where::IntExprArray,
    weight::Vector{Int32},
)
    return jcall(
        cp.cp,
        "pack",
        IloConstraint,
        (Vector{IloIntExpr}, Vector{IloIntExpr}, Vector{jint}),
        expr_load,
        expr_where,
        weight,
    )
...
function cpo_java_pack(
    ...
    return jcall(
        ...
        "pack",
        IloConstraint,
        (Vector{IloIntExpr}, Vector{IloIntExpr}, Vector{jint}, IloIntExpr),
        expr_load,
        expr_where,
        weight,
        used,
...
function cpo_java_range(
    ...
    if length(name) == 0
        ...
        return jcall(
            ...
            "range",
            IloRange,
            (jdouble, IloNumExpr, jdouble, JString),
            lb,
            expr,
            ub,
            name,
...
function cpo_java_samecommonsubsequence(
    cp::JavaCPOModel,
    seq_1::IloIntervalSequenceVar,
    seq_2::IloIntervalSequenceVar,
    name::String="",
)
    if length(name) == 0
        return jcall(
            ...
            IloConstraint,
            (IloIntervalSequenceVar, IloIntervalSequenceVar),
            seq_1,
            seq_2,
        )
    else
        return jcall(
            ...
            "sameCommonSubsequence",
            IloConstraint,
            (IloIntervalSequenceVar, IloIntervalSequenceVar, JString),
            seq_1,
            seq_2,
            name,
        )
...
function cpo_java_samecommonsubsequence(
    ...
    seq_1::IloIntervalSequenceVar,
    seq_2::IloIntervalSequenceVar,
    a_1::Vector{IloIntervalVar},
    a_2::Vector{IloIntervalVar},
    name::String="",
)
    if length(name) == 0
        return jcall(
...
function cpo_java_samesubsequence(
    cp::JavaCPOModel,
    seq_1::IloIntervalSequenceVar,
    seq_2::IloIntervalSequenceVar,
    name::String="",
...
function cpo_java_sequence(
    ...
    vars::Vector{IloIntVar},
    values::Vector{Int32},
    card::Vector{IloIntVar},
)
    return jcall(
        cp.cp,
        "sequence",
        IloConstraint,
        (jint, jint, jint, Vector{IloIntVar}, Vector{jint}, Vector{IloIntVar}),
        nbmin,
        nbmax,
        seqwidth,
        vars,
...
function cpo_java_span(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    bs::Vector{IloIntervalVar},
    name::String="",
)
    if length(name) == 0
        return jcall(
...
function cpo_java_startatstart(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    b::IloIntervalVar,
)
...
function cpo_java_startbeforeend(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    b::IloIntervalVar,
)
...
function cpo_java_startbeforestart(
    cp::JavaCPOModel,
    a::IloIntervalVar,
    b::IloIntervalVar,
)
...
function cpo_java_addable_setname(
    cp::JavaCPOModel,
    addable::Addable,
    name::String,
)
...
function cpo_java_range_setbounds(
    cp::JavaCPOModel,
    range::IloRange,
    lb::Real,
    ub::Real,
...
function cpo_java_range_setexpr(
    cp::JavaCPOModel,
    range::IloRange,
    expr::NumExpr,
)
...
function cpo_java_staticlex(
    cp::JavaCPOModel,
    criteria::NumExprArray,
    name::String="",
)
    if length(name) == 0
        return jcall(
...
function cpo_java_isfixed(cp::JavaCPOModel, var::IloIntervalSequenceVar)
    return Bool(
        jcall(cp.cp, "isFixed", jboolean, (IloIntervalSequenceVar), var),
    )
end
...
function cpo_java_isindomain(cp::JavaCPOModel, var, value::Int32)
    return Bool(
        jcall(cp.cp, "isInDomain", jboolean, (IloNumVar, jint), var, value),
    )
end
...
function cpo_java_refineconflict(cp::JavaCPOModel, constrs::ConstraintArray)
    return Bool(
        jcall(
            ...
            "refineConflict",
            jboolean,
            (Vector{IloConstraint},),
            constrs,
        ),
    )
end

function cpo_java_refineconflict(
    cp::JavaCPOModel,
    constrs::ConstraintArray,
    prefs::Vector{T},
) where {T <: Real}
    return Bool(
        jcall(
            ...
            "refineConflict",
            jboolean,
            (Vector{IloConstraint}, Vector{jdouble}),
            constrs,
            prefs,
        ),
    )
...
function cpo_java_solution_add(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_contains(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getend(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getendmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getendmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getlength(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getlengthmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getlengthmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
)
...
function cpo_java_solution_getmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
)
...
function cpo_java_solution_getsize(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getsizemax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getsizemin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getstart(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getstartmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getstartmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_getvalue(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
)
...
function cpo_java_solution_isabsent(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_isfixed(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
)
...
function cpo_java_solution_isindomain(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    value::Int32,
...
function cpo_java_solution_ispresent(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_remove(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_setabsent(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_setdomain(
    cp::JavaCPOModel,
    solution::IloSolution,
    var,
    vmin::Int32,
...
function cpo_java_solution_setend(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setendmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setendmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setlength(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setlengthmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setlengthmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
    v::Int32,
...
function cpo_java_solution_setmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
    v::Int32,
...
function cpo_java_solution_setoptional(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_setpresent(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
)
...
function cpo_java_solution_setsize(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setsizemax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setsizemin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setstart(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setstartmax(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setstartmin(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntervalVar,
    v::Int32,
...
function cpo_java_solution_setvalue(
    cp::JavaCPOModel,
    solution::IloSolution,
    var::IloIntVar,
    v::Int32,
...
function cpo_java_setintparameter(cp::JavaCPOModel, name::String, value::String)
    ...
    return jcall(
        ...
        "setParameter",
        Nothing,
        (IloIntParam, IloParameterValues),
        param,
        field,
    )
end
